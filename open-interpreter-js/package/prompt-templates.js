const preInstalledPackages = "pupeteer, cheerio, axios, and fs";
...
!IMPORTANT! = Code steps are NOT connected you cant use a variable of step 1 in 2, for sharing use the variable **state={...}** !IMPORTANT!.
